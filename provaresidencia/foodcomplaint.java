...
public class foodcomplaint {
    ...
    private static foodcomplaint instanceFoodcomplaint;
    ...
    public foodcomplaint(Context context2) {
    }

    public static synchronized foodcomplaint getInstancefFoodcomplaint(Context context) {
        if(instanceFoodcomplaint == null)
        instanceFoodcomplaint = new foodcomplaint(context);

        return instanceFoodcomplaint;
    }
    
    public List<registro> getInstancefFoodcomplaint() {
